export default {
  ...
  video_10_sec_watched_actions: { id: 'video_10_sec_watched_actions', path: '$.video_10_sec_watched_actions[?(@.action_type==\'video_view\')].value' },
  cost_per_10_sec_video_view: { id: 'cost_per_10_sec_video_view', path: '$.cost_per_10_sec_video_view[?(@.action_type==\'video_view\')].value' },
  video_avg_percent_watched_actions: { id: 'video_avg_percent_watched_actions', path: '$.video_avg_percent_watched_actions[?(@.action_type==\'video_view\')].value' },
